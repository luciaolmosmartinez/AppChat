...
public class VentanaLogin {
	...
	private void initialize() {
		...
		btnRegistrar.setIcon(new ImageIcon(VentanaLogin.class.getResource("/vista/imagenes/nuevo.png")));
		...
		btnLogin.setIcon(new ImageIcon(VentanaLogin.class.getResource("/vista/imagenes/contrasena.png")));
		...
		logo.setIcon(new ImageIcon(VentanaLogin.class.getResource("/vista/imagenes/chat.png")));
