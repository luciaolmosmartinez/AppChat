...
public class Ventana_main2 extends JFrame {
	...
	private GridBagConstraints gbc_bubble_1, gbc_button, gbc_textField, gbc_button_1, gbc_btnNewButton,
			gbc_btnNewButton_1, gbc_bubble;
	private Panel panel_2, panel_3;
	private Button button, button_1;
	private JTextField textField;
	private JButton btnNewButton, btnNewButton_1;
	private JScrollPane scrollPane, scrollPane_1;
	private JList list_1;
	private GridBagLayout gbl_panel_2, gbl_panel_3;
	private BubbleText bubble, bubble1;
	...
	public Ventana_main2() {
		...
		gbc_button_1 = new GridBagConstraints();
		...
		bubble = new BubbleText(panel_4, 0, Color.PINK, "jaja", BubbleText.RECEIVED, 10);
		...
		gbc_bubble = new GridBagConstraints();
		gbc_bubble.gridx = 0;
		gbc_bubble.gridy = 0;
		bubble1 = new BubbleText(panel_4, "hola", Color.PINK, "jaja", BubbleText.SENT, 10);
